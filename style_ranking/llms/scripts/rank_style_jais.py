...
# model = AutoModelForCausalLM.from_pretrained(model_path, device_map="auto", offload_folder="offload", trust_remote_code=True, cache_dir=cache_dir)
...
def execute_prompt(list_text_snippets):
  ...
  prompt+= "The seven comma-separated rankings are "
